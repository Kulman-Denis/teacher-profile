...
bio: string[] = [
  `Вадим Єрмолаєв — професор семантичних технологій кафедри комп’ютерних наук 
  та інформаційних технологій Українського католицького університету (УКУ), 
  директор докторської програми з інтелектуальних систем факультету 
  прикладних наук (APPS) UCU та почесний професор 
  Херсонського державного університету (ХДУ).`,

  `З 1991 року бере участь у міжнародних дослідницьких проєктах як науковий 
  співробітник, координатор та експерт у програмах Європейської Комісії 
  (FP6, FP7, H2020), Міністерства освіти і науки України та інших організацій. 
  Є членом ACM та ELLIS, а також засновником дослідницької групи 
  «Інтелектуальні системи» Запорізького національного університету (ЗНУ).`
];
